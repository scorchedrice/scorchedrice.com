...
git_link: "https://github.com/scorchedrice/slack-bot"
sub_title: "자바스크립트 알고리즘 학습 보조 목적의 슬랙봇"
summary: ["데브코스 수강생들에게 도움을 주고자 직접 개발", "문제 랜덤 추천, 자료구조 예시코드 제공 기능 개발"]
---

import slackBotLogic1 from "./slack-bot-logic1.png";
...
슬랙봇의 구성은 크게 <u>**slack에서 입력한 슬래시 명령어를 처리하는 command**</u>, <u>**버튼 클릭과 같은 이벤트를 처리하는 handler**</u>, <u>**비즈니스 로직을 처리하는 service**</u>로 구성되어 있어요.

#### 첫번째, 슬래시 명령어를 처리하는 과정

<img src={slackBotLogic1} alt="test" className="mx-auto"/>
...
복잡한 기능은 아니였지만 함께 공부하는 데브코스분들을 위해 개발하고 서비스하는 과정이 너무나 즐거웠어요.

평소 개발자가 갖춰야 하는 핵심역량이 문제를 인식하고 이를 해결하기 위해 기술에 구애받지 않고 추진할 수 있는 역량이라고 생각했는데, 이와 부합한 프로젝트였기에 더욱 가치있는 프로젝트라고 생각해요.

제가 개발한 코드는 <a href="https://github.com/scorchedrice/slack-bot">여기</a>에서 확인하실 수 있으니 참고해보시면 좋을 것 같아요!