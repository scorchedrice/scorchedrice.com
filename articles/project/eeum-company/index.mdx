...
git_link: ""
sub_title: "출장 세차 서비스를 중심적으로 제공하는 스타트업, 이음컴퍼니 브랜드페이지 개발"
summary: ["API route를 활용한 백엔드 기능 구현", "협업툴과 연동되는 상담예약 시스템 개발 (진행예정)"]
---
...
`shadcn/ui`의 form 활용하여 유효성 판단 기능을 구현했고, `react-daum-postcode` 라이브러리 활용하여 주소값을 입력할 수 있도록 기능을 구현했어요.
