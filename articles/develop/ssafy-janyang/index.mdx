...
date: "2024-07-31"
category: "프로젝트"
tags: ["SSAFY", "Flutter", "Lottie"]
slug: "ssafy-janyang"
hero_image: "./janyang.png"
hero_image_alt: "janyang.png"
git_link: ""
sub_title: "Flutter & OpenVidu 활용 화상회의 형식의 미션참여형 알람앱"
summary: ["FE 2, BE 4으로 진행된 팀 프로젝트", "Lottie를 활용한 Animated Logo 제작", "튜토리얼 기능 구현", "미션 참여 결과 제공 기능 구현", "다크모드 / 라이트모드 구현"]
---
...
이 프로젝트에서 제가 구현한 기능 중 핵심기능을 중심적으로 소개할게요.
